...
ALTER TABLE contacts ADD COLUMN legacy_id VARCHAR(100) UNIQUE;
ALTER TABLE subscribers ADD COLUMN legacy_id VARCHAR(100) UNIQUE;
ALTER TABLE invoices ADD COLUMN legacy_id VARCHAR(100) UNIQUE;
ALTER TABLE invoice_items ADD COLUMN legacy_id VARCHAR(100) UNIQUE;
ALTER TABLE expenses ADD COLUMN legacy_id VARCHAR(100) UNIQUE;
ALTER TABLE cashbook_entries ADD COLUMN legacy_id VARCHAR(100) UNIQUE;
